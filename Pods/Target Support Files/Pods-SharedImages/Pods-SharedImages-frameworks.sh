...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Karte/Karte.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KeychainAccess/KeychainAccess.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LGSideMenuController/LGSideMenuController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LMGeocoderUniversal/LMGeocoderUniversal.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LottiesBottom/LottiesBottom.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ODRefreshControl/ODRefreshControl.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ObjcExceptionBridging/ObjcExceptionBridging.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PersistentValue/PersistentValue.framework"
  ...
  install_framework "${PODS_ROOT}/SMGoogleSignIn/Framework/GoogleSignIn.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SMLinkPreview/SMLinkPreview.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/rosterdev/rosterdev.framework"
fi
