...
public struct SyncAttributes : FileUUID, Hashable {
    ...
    public init(fileUUID:UUIDString, sharingGroupId: SharingGroupId, mimeType:MimeType, fileGroupUUID: UUIDString? = nil, creationDate: Date? = nil, updateDate: Date? = nil) {
