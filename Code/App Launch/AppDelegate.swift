...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Version 0.22.0 of the server is the first with the new parameters for sharing invitation creation-- number acceptors and allow social acceptance.
        SyncServer.session.appLaunchSetup(withServerURL: serverURL, logger: Log, cloudFolderName:cloudFolderName, minimumServerVersion: ServerVersion(rawValue: "0.22.0"), failoverMessageURL: failoverURL)
